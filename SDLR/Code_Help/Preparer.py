...
### Download Sample Data (MQ2008 Fold1)
Response = requests.get("https://raw.githubusercontent.com/sanazkeshvari/Papers/main/SDLR/Code_Help/MQ2008_Fold1.zip")
with open("./MQ2008_Fold1.zip", "wb") as F:
  F.write(Response.content)
Response.close()

#if not os.path.isdir("./Data/MQ2008/Fold1/"): os.makedirs("./Data/MQ2008/Fold1/")
shutil.unpack_archive("./MQ2008_Fold1.zip", "./Datasets/MQ2008/Fold1/")


Info_File = open("./Datasets/MQ2008/Fold1/lambdarank_atmax1.json", "r")
Info = Info_File.read()
Info_File.close()

Dataset_Address_Index = Info.find("path_to_dataset")
Info = Info.replace(Info[Dataset_Address_Index - 1: Dataset_Address_Index + 16], os.getcwd() + "/Datasets/MQ2008/Fold1/")

Info_File = open("./Datasets/MQ2008/Fold1/lambdarank_atmax1.json", "w")
Info_File.write(Info)
Info_File.close()


shutil.copy("./Datasets/MQ2008/Fold1/lambdarank_atmax1.json", "./Teacher/allrank/in/lambdarank_atmax1.json")
shutil.move("./Datasets/MQ2008/Fold1/lambdarank_atmax1.json", "./Student/allrank/in/lambdarank_atmax1.json")
