...
def parse_args(i) -> Namespace:
    ...
    parser.add_argument("--run-id", help="Name of this run to be recorded (must be unique within output dir)", required=False, default="/home/ppl/Keshvari/Dataset/allRank-master01P(x)_20230622/out"+str(i)+"/")
